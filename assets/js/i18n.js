...
const I18N = {
  ru: {
    ...
    'flow.senders': 'Откуда пришло · {n} адресов',
    'flow.receivers': 'Куда ушло · {n} адресов',
    'flow.inWord': 'получено',
    'flow.outWord': 'отправлено',
    ...
    'peers.hint': 'клик — выбрать, ПКМ — скрыть',
    'hide.title': 'Скрыто со схемы',
    'hide.all': 'Показать все',
    ...
    'msg.error': 'Ошибка: {e}',
    'msg.ratelimit': '{c}: провайдер ограничил частоту запросов. Подождите минуту и повторите, либо добавьте ключ API в настройках — с ключом лимит выше.',
    'dir.in': 'Вход',
    'dir.out': 'Выход',
  ...
  en: {
    ...
    'view.time': 'Timeline',
    'flow.in': 'Came from · {v}',
    'flow.senders': 'Came from · {n} addresses',
    'flow.receivers': 'Went to · {n} addresses',
    'flow.inWord': 'received',
    'flow.outWord': 'sent',
    'flow.out': 'Went to · {v}',
    ...
    'graph.fit': 'Fit',
    'graph.full': 'Fullscreen',
    'graph.exit': 'Exit fullscreen',
    'graph.export': 'PNG',
    ...
    'peers.hint': 'click to select, right-click to hide',
    'hide.title': 'Hidden from the map',
    'hide.all': 'Show all',
    ...
    'msg.error': 'Error: {e}',
    'msg.ratelimit': '{c}: the provider is rate limiting requests. Wait a minute and retry, or add an API key in settings — the limit is higher with one.',
    'dir.in': 'In',
    'dir.out': 'Out',
