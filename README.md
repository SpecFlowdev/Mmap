...
<p align="center">
  <img src="docs/graph.png" alt="Схема переводов кошелька" width="760">
</p>
...
- **Схема переводов** — интерактивный force-directed граф на canvas: в центре твой кошелёк,
  вокруг контрагенты. Размер узла и толщина связи = оборот, цвет = направление.
  Зум колесом, перетаскивание узлов, экспорт в PNG, двойной клик по узлу — фильтр по контрагенту.
