...
- Публичные API ограничивают частоту запросов: при ответе 429 панель повторяет запрос
  с нарастающей паузой и подсказывает добавить ключ провайдера — с ключом лимит выше.
